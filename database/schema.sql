...
CREATE TABLE IF NOT EXISTS offers (
 ...
 shipping_window_hours INT NULL,
...
CREATE TABLE IF NOT EXISTS orders (
 ...
 shipping_due_at DATETIME NULL,
 digital_rules_snapshot_json JSON NULL,
 digital_due_at DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS evidences (
 ...
 order_component_id BIGINT UNSIGNED NULL,
 seller_id BIGINT UNSIGNED NOT NULL,
 evidence_type ENUM('precheck','daily','spontaneous','task','damage','shipping','digital','item_proposal') NOT NULL,
 day_no INT NULL,
...
CREATE TABLE IF NOT EXISTS payout_profiles (
 ...
 preferred_method ENUM('bank','paypal') NULL,
