...
<button class="btn danger">Beanstandung speichern</button></form></details><?php elseif($evd['status']==='rejected'):?><span class="meta"><?=e($evd['rejection_reason']??'')?></span><?php endif;?></div></div></div><?php endforeach;?>
   ...
   <hr><div class="actions"><a class="btn secondary" href="<?=e(url('/admin/auftrag/'.$o['order_no'].'/aendern'))?>">Auftragsdaten ändern</a><a class="btn secondary" href="<?=e(url('/admin/auftrag/'.$o['order_no'].'/nachweisplan'))?>">Nachweisplan ändern</a><a class="btn secondary" href="<?=e(url('/admin/auftrag/'.$o['order_no'].'/chat'))?>">Auftragschat</a><a class="btn secondary" href="<?=e(url('/admin/auftrag/'.$o['order_no'].'/zwischenstaende'))?>">Zwischenstände</a></div></section>
 </div>
