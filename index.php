...
if(preg_match('#^/admin/auftrag/(\\d{8})$#',$path,$m)&&$method==='GET'){
 ...
 <div class="grid two" style="margin-top:18px">
   ...
   <?php if($extraDays):?><h3>Zusätzliche Tage</h3><div class="timeline"><?php foreach($extraDays as $x):?><div><?=e($x['source_type'])?> · <?=$x['paid']?('bezahlt '.money($x['amount'])):'unbezahlt'?><?= $x['reason']?' · '.e($x['reason']):'' ?></div><?php endforeach;?></div><?php endif;?></section>
