...
<div>
<span class="eyebrow">Auftragsnachrichten</span>
<h1>{{ $conversation->subject }}</h1>
<p>Auftrag #{{ $conversation->order->order_number }}</p>
</div>
<a class="btn secondary" href="{{ route('messages.index') }}">← Nachrichten</a>
</div>
...
@else
<div class="notice" style="margin-top:16px">Dieser Auftrag ist seit mehr als 7 Tagen abgeschlossen. Der Verlauf bleibt lesbar; neue Nachrichten sind nicht mehr möglich.</div>
@endif
@endsection
