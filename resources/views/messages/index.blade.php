...
<aside class="panel"><h2>Neue Nachricht</h2><form method="post" action="{{ route('messages.store') }}" class="stack-form">@csrf
...
<button class="btn primary wide">Nachricht senden</button></form></aside>
</div>
@endsection
