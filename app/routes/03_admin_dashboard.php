...
if ($path === '/admin' && $method === 'GET') {
    ...
    ob_start(); ?><div class="page-head"><div><span class="eyebrow">Admin</span><h1>Übersicht</h1><p>Alles Wichtige auf einen Blick.</p></div><a class="btn" href="<?=e(url('/admin/offers/new'))?>">+ Angebot erstellen</a></div>
    <div class="stats"><div class="stat"><span>Offene Angebote</span><strong><?=$stats['offers']?></strong></div><div class="stat"><span>Vorabkontrollen</span><strong><?=$stats['precheck']?></strong></div><div class="stat"><span>Zu prüfende Tage</span><strong><?=$stats['review']?></strong></div><div class="stat"><span>Laufende Aufträge</span><strong><?=$stats['running']?></strong></div></div>
