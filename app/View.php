...
<header class="topbar">
  ...
  <nav>
    ...
    <?php elseif ($admin): ?><a href="<?= e(url('/admin')) ?>">Admin</a><a href="<?= e(url('/admin/heute')) ?>">Heute</a><a href="<?= e(url('/admin/suche')) ?>">Suche</a><a href="<?= e(url('/admin/auftraege')) ?>">Aufträge</a><a href="<?= e(url('/admin/archiv')) ?>">Archiv</a><a href="<?= e(url('/admin/kalender')) ?>">Kalender</a><a href="<?= e(url('/admin/ausfaelle')) ?>">Ausfälle</a><a href="<?= e(url('/admin/einzelangebote')) ?>">Einzelangebote</a><a href="<?= e(url('/admin/angebotsvorlagen')) ?>">Vorlagen</a><a href="<?= e(url('/admin/aufgabenbibliothek')) ?>">Aufgaben</a><a href="<?= e(url('/admin/verkaeuferinnen')) ?>">Verkäuferinnen</a><a href="<?= e(url('/admin/auszahlungen')) ?>">Auszahlungen</a><a href="<?= e(url('/admin/einstellungen')) ?>">Einstellungen</a><a href="<?= e(url('/admin/logout')) ?>">Abmelden</a>
