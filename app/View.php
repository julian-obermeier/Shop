...
<header class="topbar">
  ...
  <nav>
    ...
    <?php if ($seller): ?><a href="<?= e(url('/heute')) ?>">Heute</a><a href="<?= e(url('/dashboard')) ?>">Dashboard</a><a href="<?= e(url('/individuelle-angebote')) ?>">Einzelangebote</a><a href="<?= e(url('/wallet')) ?>">Wallet</a><a href="<?= e(url('/profil')) ?>">Profil</a><a href="<?= e(url('/logout')) ?>">Abmelden</a>
    <?php elseif ($admin): ?><a href="<?= e(url('/admin')) ?>">Admin</a><a href="<?= e(url('/admin/suche')) ?>">Suche</a><a href="<?= e(url('/admin/auftraege')) ?>">Aufträge</a><a href="<?= e(url('/admin/einzelangebote')) ?>">Einzelangebote</a><a href="<?= e(url('/admin/aufgabenbibliothek')) ?>">Aufgaben</a><a href="<?= e(url('/admin/verkaeuferinnen')) ?>">Verkäuferinnen</a><a href="<?= e(url('/admin/auszahlungen')) ?>">Auszahlungen</a><a href="<?= e(url('/admin/einstellungen')) ?>">Einstellungen</a><a href="<?= e(url('/admin/logout')) ?>">Abmelden</a>
